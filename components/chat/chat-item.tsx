            ...
            <div className="flex flex-col w-full">
                ...
                {isImage && (
                    <a href={fileUrl}
                        ...
                        className="relative aspect-square rounded-md mt-2 overflow-hidden border flex items-center bg-black/50 h-48 w-48">
                        <Image src={fileUrl}
                            alt={content}
                            fill
                ...
                {isPdf && (
                    <div className="relative flex items-center p-2 mt-2 rounded-md bg-neutral-500/10">
                ...
                {!fileUrl && isEditing && (
                    <Form {...form}>
                                    ...
                                    <FormItem className="flex-1 ">
                                        <FormControl>
                                            <div className="relative w-full ">
                                                <Input disabled={isLoading} className="p-2 bg-zinc-200/90 dark:bg-zinc-700/75 border-none focus-visible:ring-0 focus-visible:ring-offset-0 text-zinc-600 dark:text-zinc-200 " placeholder="Edited Message" />
                                            </div>
                                        </FormControl>
                                    </FormItem>
                                )}
                        ...
                        <span className="text-[10px] mt-1 text-zinc-400">
                            Press <kbd>Enter</kbd> to send, cancel with <kbd>Esc</kbd>
                        </span>
                    </Form>
                )}
            </div>
